...
// @@protoc_insertion_point(message:models.SwapNodeDetails)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct SwapNodeDetails {
    // message fields
    // @@protoc_insertion_point(field:models.SwapNodeDetails.processes)
    pub processes: ::std::vec::Vec<SwapProcessDetails>,
    // special fields
    // @@protoc_insertion_point(special_field:models.SwapNodeDetails.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a SwapNodeDetails {
    fn default() -> &'a SwapNodeDetails {
        <SwapNodeDetails as ::protobuf::Message>::default_instance()
    }
}

impl SwapNodeDetails {
    pub fn new() -> SwapNodeDetails {
        ::std::default::Default::default()
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "processes",
            |m: &SwapNodeDetails| { &m.processes },
            |m: &mut SwapNodeDetails| { &mut m.processes },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<SwapNodeDetails>(
            "SwapNodeDetails",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for SwapNodeDetails {
    const NAME: &'static str = "SwapNodeDetails";
    ...
    fn default_instance() -> &'static SwapNodeDetails {
        static instance: SwapNodeDetails = SwapNodeDetails {
...
impl ::protobuf::MessageFull for SwapNodeDetails {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("SwapNodeDetails").unwrap()).clone()
    }
}

impl ::std::fmt::Display for SwapNodeDetails {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for SwapNodeDetails {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

// @@protoc_insertion_point(message:models.SwapProcessDetails)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct SwapProcessDetails {
    // message fields
    // @@protoc_insertion_point(field:models.SwapProcessDetails.processId)
    pub processId: u64,
    // @@protoc_insertion_point(field:models.SwapProcessDetails.parentProcessId)
    pub parentProcessId: u64,
    // @@protoc_insertion_point(field:models.SwapProcessDetails.swapUsed)
    pub swapUsed: u64,
    // @@protoc_insertion_point(field:models.SwapProcessDetails.processName)
    pub processName: ::std::string::String,
    // special fields
    // @@protoc_insertion_point(special_field:models.SwapProcessDetails.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a SwapProcessDetails {
    fn default() -> &'a SwapProcessDetails {
        <SwapProcessDetails as ::protobuf::Message>::default_instance()
    }
}

impl SwapProcessDetails {
    pub fn new() -> SwapProcessDetails {
        ::std::default::Default::default()
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "processId",
            |m: &SwapProcessDetails| { &m.processId },
            |m: &mut SwapProcessDetails| { &mut m.processId },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "parentProcessId",
            |m: &SwapProcessDetails| { &m.parentProcessId },
            |m: &mut SwapProcessDetails| { &mut m.parentProcessId },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "swapUsed",
            |m: &SwapProcessDetails| { &m.swapUsed },
            |m: &mut SwapProcessDetails| { &mut m.swapUsed },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "processName",
            |m: &SwapProcessDetails| { &m.processName },
            |m: &mut SwapProcessDetails| { &mut m.processName },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<SwapProcessDetails>(
            "SwapProcessDetails",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for SwapProcessDetails {
    const NAME: &'static str = "SwapProcessDetails";
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                8 => {
                    self.processId = is.read_uint64()?;
                },
                16 => {
                    self.parentProcessId = is.read_uint64()?;
                },
                24 => {
                    self.swapUsed = is.read_uint64()?;
                },
                34 => {
                    self.processName = is.read_string()?;
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.processId != 0 {
            my_size += ::protobuf::rt::uint64_size(1, self.processId);
        }
        if self.parentProcessId != 0 {
            my_size += ::protobuf::rt::uint64_size(2, self.parentProcessId);
        }
        if self.swapUsed != 0 {
            my_size += ::protobuf::rt::uint64_size(3, self.swapUsed);
        }
        if !self.processName.is_empty() {
            my_size += ::protobuf::rt::string_size(4, &self.processName);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.processId != 0 {
            os.write_uint64(1, self.processId)?;
        }
        if self.parentProcessId != 0 {
            os.write_uint64(2, self.parentProcessId)?;
        }
        if self.swapUsed != 0 {
            os.write_uint64(3, self.swapUsed)?;
        }
        if !self.processName.is_empty() {
            os.write_string(4, &self.processName)?;
        }
        os.write_unknown_fields(self.special_fields.unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn new() -> SwapProcessDetails {
        SwapProcessDetails::new()
    }
    ...
    fn default_instance() -> &'static SwapProcessDetails {
        static instance: SwapProcessDetails = SwapProcessDetails {
            processId: 0,
            parentProcessId: 0,
            swapUsed: 0,
            processName: ::std::string::String::new(),
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
impl ::protobuf::MessageFull for SwapProcessDetails {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("SwapProcessDetails").unwrap()).clone()
    }
}

impl ::std::fmt::Display for SwapProcessDetails {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for SwapProcessDetails {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}
...
impl ::protobuf::Enum for SeverityLevel {
    ...
    fn from_str(str: &str) -> ::std::option::Option<SeverityLevel> {
        match str {
            "NONE" => ::std::option::Option::Some(SeverityLevel::NONE),
            "INFO" => ::std::option::Option::Some(SeverityLevel::INFO),
            "WARN" => ::std::option::Option::Some(SeverityLevel::WARN),
            "AVG" => ::std::option::Option::Some(SeverityLevel::AVG),
            "HIGH" => ::std::option::Option::Some(SeverityLevel::HIGH),
            "CRITICAL" => ::std::option::Option::Some(SeverityLevel::CRITICAL),
            "DISASTER" => ::std::option::Option::Some(SeverityLevel::DISASTER),
            _ => ::std::option::Option::None
        }
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    al\x12\x1a\n\x08SwapFree\x18\n\x20\x01(\x04R\x08SwapFree\"K\n\x0fSwapNod\
    eDetails\x128\n\tprocesses\x18\x05\x20\x03(\x0b2\x1a.models.SwapProcessD\
    etailsR\tprocesses\"\x9a\x01\n\x12SwapProcessDetails\x12\x1c\n\tprocessI\
    d\x18\x01\x20\x01(\x04R\tprocessId\x12(\n\x0fparentProcessId\x18\x02\x20\
    \x01(\x04R\x0fparentProcessId\x12\x1a\n\x08swapUsed\x18\x03\x20\x01(\x04\
    R\x08swapUsed\x12\x20\n\x0bprocessName\x18\x04\x20\x01(\tR\x0bprocessNam\
    e*\\\n\rSeverityLevel\x12\x08\n\x04NONE\x10\0\x12\x08\n\x04INFO\x10\x01\
    \x12\x08\n\x04WARN\x10\x02\x12\x07\n\x03AVG\x10\x03\x12\x08\n\x04HIGH\
    \x10\x04\x12\x0c\n\x08CRITICAL\x10\x05\x12\x0c\n\x08DISASTER\x10\x06b\
    \x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(SwapNodeDetails::generated_message_descriptor_data());
            messages.push(SwapProcessDetails::generated_message_descriptor_data());
